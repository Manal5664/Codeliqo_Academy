...
export type ProgramCategory = 'software-development' | 'data-science' | 'artificial-intelligence';
...
export interface Assignment { id: string; title: string; week: number; instructions: string; due_date: string | null; created_at: string; assignment_submissions?: AssignmentSubmission[] }
export interface AssignmentSubmission { id: string; assignment_id: string; submission_url: string | null; status: 'not_started' | 'in_progress' | 'submitted' | 'reviewed'; feedback: string | null }
...
export interface Certificate { id: string; certificate_id: string | null; program_name: string; issue_date: string | null; status: string; file_url: string | null; student_name?: string }
